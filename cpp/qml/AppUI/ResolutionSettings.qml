...
FocusScope {
    ...
    // Preview image mapping: emuId → INI value → image path
    property var previewImages: ({
        "duckstation": { "2": "images/res/duckstation-720p.webp", "3": "images/res/duckstation-1080p.webp",
                         "4": "images/res/duckstation-1440p.webp", "6": "images/res/duckstation-4k.webp" }
    })
            ...
            Flow {
                ...
                Repeater {
                    ...
                    delegate: Item {
                        ...
                        property string selectedValue: root.pendingChoices[cardData.emuId] || cardData.current
                            ...
                            Row {
                                ...
                                Repeater {
                                    ...
                                    delegate: Rectangle {
                                        ...
                                        property bool isSelected: selectedValue === modelData.value
