...
QString Paths::dataDir(const QString& emuId) {
    if (emuId.isEmpty()) return s_root + "/data";
    return s_root + "/data/" + emuId;
}
...
QString Paths::savesDir(const QString& systemId) {
    if (systemId.isEmpty()) return s_root + "/saves";
    return s_root + "/saves/" + systemId;
}

QString Paths::cacheDir(const QString& systemId) {
    if (systemId.isEmpty()) return s_root + "/cache";
    return s_root + "/cache/" + systemId;
}
