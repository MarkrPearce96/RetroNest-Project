...
DSPopnBindingsWidget::DSPopnBindingsWidget(SdlInputManager* inputManager,
    ...
    : BindingsWidgetBase(inputManager, appController, emuId, port, parent)
{
    ...
    row1->setSpacing(8);
    row1->addStretch();
    row1->addWidget(makeBindGroup("Left White"));
    row1->addWidget(makeBindGroup("Left Yellow"));
    row1->addWidget(makeBindGroup("Left Green"));
    row1->addWidget(makeBindGroup("Left Blue"));
    row1->addWidget(makeBindGroup("Middle Red"));
    row1->addWidget(makeBindGroup("Right Blue"));
    row1->addWidget(makeBindGroup("Right Green"));
    row1->addWidget(makeBindGroup("Right Yellow"));
    row1->addWidget(makeBindGroup("Right White"));
    row1->addStretch();
