...
class Pcsx2MemoryCardsPage : public QWidget {
    Q_OBJECT
public:
    explicit Pcsx2MemoryCardsPage(Pcsx2SettingsDialog* dialog);
signals:
...
private:
    ...
    QLabel* m_slot1FilenameLabel = nullptr;
    QLabel* m_slot2FilenameLabel = nullptr;
};
